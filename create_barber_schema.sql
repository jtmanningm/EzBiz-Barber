...
-- Customer indexes
CREATE INDEX IF NOT EXISTS IDX_CUSTOMER_EMAIL ON OPERATIONAL.BARBER.CUSTOMER(EMAIL_ADDRESS);
CREATE INDEX IF NOT EXISTS IDX_CUSTOMER_PHONE ON OPERATIONAL.BARBER.CUSTOMER(PHONE_NUMBER);

-- Transaction indexes
CREATE INDEX IF NOT EXISTS IDX_SERVICE_TRANSACTION_CUSTOMER ON OPERATIONAL.BARBER.SERVICE_TRANSACTION(CUSTOMER_ID);
CREATE INDEX IF NOT EXISTS IDX_SERVICE_TRANSACTION_DATE ON OPERATIONAL.BARBER.SERVICE_TRANSACTION(SERVICE_DATE);
CREATE INDEX IF NOT EXISTS IDX_SERVICE_TRANSACTION_STATUS ON OPERATIONAL.BARBER.SERVICE_TRANSACTION(STATUS);
CREATE INDEX IF NOT EXISTS IDX_SERVICE_TRANSACTION_COMPLETION ON OPERATIONAL.BARBER.SERVICE_TRANSACTION(COMPLETION_DATE);

-- Portal user indexes
CREATE INDEX IF NOT EXISTS IDX_CUSTOMER_PORTAL_EMAIL ON OPERATIONAL.BARBER.CUSTOMER_PORTAL_USERS(EMAIL);
CREATE INDEX IF NOT EXISTS IDX_BUSINESS_PORTAL_EMAIL ON OPERATIONAL.BARBER.BUSINESS_PORTAL_USERS(EMAIL);

-- Session indexes
CREATE INDEX IF NOT EXISTS IDX_CUSTOMER_SESSIONS_USER ON OPERATIONAL.BARBER.CUSTOMER_SESSIONS(PORTAL_USER_ID);
CREATE INDEX IF NOT EXISTS IDX_BUSINESS_SESSIONS_USER ON OPERATIONAL.BARBER.BUSINESS_SESSIONS(PORTAL_USER_ID);
CREATE INDEX IF NOT EXISTS IDX_SESSIONS_EXPIRES ON OPERATIONAL.BARBER.CUSTOMER_SESSIONS(EXPIRES_AT);

-- Assignment indexes
CREATE INDEX IF NOT EXISTS IDX_SERVICE_ASSIGNMENTS_TRANSACTION ON OPERATIONAL.BARBER.SERVICE_ASSIGNMENTS(TRANSACTION_ID);
CREATE INDEX IF NOT EXISTS IDX_SERVICE_ASSIGNMENTS_EMPLOYEE ON OPERATIONAL.BARBER.SERVICE_ASSIGNMENTS(EMPLOYEE_ID);
